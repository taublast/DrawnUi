...
namespace DrawnUi.Draw
{
    ...
    public class EasingTypeConverter : TypeConverter
    {
        ...
        public override object? ConvertFrom(ITypeDescriptorContext? context, CultureInfo? culture, object value)
        {
            ...
            {
                _ when Compare(strValue, nameof(Easing.Linear)) => Easing.Linear,
                _ when Compare(strValue, nameof(Easing.SinIn)) => Easing.SinIn,
                _ when Compare(strValue, nameof(Easing.SinOut)) => Easing.SinOut,
                _ when Compare(strValue, nameof(Easing.SinInOut)) => Easing.SinInOut,
                _ when Compare(strValue, nameof(Easing.CubicIn)) => Easing.CubicIn,
                _ when Compare(strValue, nameof(Easing.CubicOut)) => Easing.CubicOut,
                _ when Compare(strValue, nameof(Easing.CubicInOut)) => Easing.CubicInOut,
                _ when Compare(strValue, nameof(Easing.BounceIn)) => Easing.BounceIn,
                _ when Compare(strValue, nameof(Easing.BounceOut)) => Easing.BounceOut,
                _ when Compare(strValue, nameof(Easing.SpringIn)) => Easing.SpringIn,
                _ when Compare(strValue, nameof(Easing.SpringOut)) => Easing.SpringOut,
        ...
        public override object? ConvertTo(ITypeDescriptorContext? context, CultureInfo? culture, object? value, Type destinationType)
        {
            ...
            {
                _ when easing.Equals(Easing.Linear) => nameof(Easing.Linear),
                _ when easing.Equals(Easing.SinIn) => nameof(Easing.SinIn),
                _ when easing.Equals(Easing.SinOut) => nameof(Easing.SinOut),
                _ when easing.Equals(Easing.SinInOut) => nameof(Easing.SinInOut),
                _ when easing.Equals(Easing.CubicIn) => nameof(Easing.CubicIn),
                _ when easing.Equals(Easing.CubicOut) => nameof(Easing.CubicOut),
                _ when easing.Equals(Easing.CubicInOut) => nameof(Easing.CubicInOut),
                _ when easing.Equals(Easing.BounceIn) => nameof(Easing.BounceIn),
                _ when easing.Equals(Easing.BounceOut) => nameof(Easing.BounceOut),
                _ when easing.Equals(Easing.SpringIn) => nameof(Easing.SpringIn),
                _ when easing.Equals(Easing.SpringOut) => nameof(Easing.SpringOut),
