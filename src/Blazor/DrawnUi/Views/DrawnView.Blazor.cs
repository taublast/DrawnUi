...
namespace DrawnUi.Views
{
        ...
        IDrawnBase, IAnimatorsManager
    {
        ...
        {
            //todo can do something for hotreload etc
            if (subscribe)
            {
        ...
        protected override SizeRequest OnMeasure(double widthConstraint, double heightConstraint)
        {
            ...
            var custom = new SizeRequest(new(measured.Units.Width, measured.Units.Height),
            ...
            try
            {
                ...
                foreach (var skiaAnimation in PostAnimators)
                {
                    if (skiaAnimation.IsRunning && !skiaAnimation.IsPaused)
                    {
                        ...
                        {
                            var renderedrawn = renderer.Render(new DrawingContext(context, DrawingRect, (float)scale),
                                this);
                        }
        ...
        private void OnBlazorFrame(object sender, EventArgs e)
        {
