...
namespace winrt::SkiaSharp::DrawnUi::WinUI::Native::implementation
{
    struct PropertySetExtensions
    {
        ...
        static void AddSingle(winrt::Windows::Foundation::Collections::PropertySet const& propertySet, hstring const& key, float value);
        static void AddSize(winrt::Windows::Foundation::Collections::PropertySet const& propertySet, hstring const& key, winrt::Windows::Foundation::Size const& value);
    };
}
